#ifndef TEST_CPU_GROTTO_TEST_GROTTO_EQ_EVAL_HPP
#define TEST_CPU_GROTTO_TEST_GROTTO_EQ_EVAL_HPP
...
public:
    static void run(std::size_t bitWidthIn,
                    ...
                    MT19937Rng &rng)
    {
        std::printf("[cpu test GrottoEqEval] "   //
                    "elementSize = %2d "         //
                    "bitWidthIn  = %3d "         //
                    "elementNum  = %5d .... ",   //
