...
FAST_FSS_API int FastFss_cuda_grottoKeyGen(void       *key,
                                           size_t      keyDataSize,
                                           const void *alpha,
...
FAST_FSS_API int FastFss_cuda_grottoEqEval(void       *sharedBooleanOut,
...
FAST_FSS_API int FastFss_cuda_grottoEval(void       *sharedBooleanOut,
                                         size_t      sharedOutDataSize,
                                         const void *maskedX,
                                         size_t      maskedXDataSize,
                                         const void *key,
...
FAST_FSS_API int FastFss_cuda_grottoMICEval(void       *sharedBooleanOut,
...
FAST_FSS_API int FastFss_cuda_grottoIntervalLutEval(void       *sharedOutE,
