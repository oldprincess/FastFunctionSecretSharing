...
#ifndef FAST_FSS_CUDA_MIC_H
#define FAST_FSS_CUDA_MIC_H
...
FAST_FSS_API int FastFss_cuda_dcfMICKeyGen(void       *key,
                                           size_t      keyDataSize,
                                           void       *z,
                                           size_t      zDataSize,
                                           const void *alpha,
...
FAST_FSS_API int FastFss_cuda_dcfMICEval(void       *sharedOut,
