...
def test(bit_width: int, device: torch.device):
    ...
    shared_out0 = pyFastFss.grotto_eq_multi_eval(shared_out0, masked_x, key, seed0, 0, points, bit_width, element_num)
    shared_out1 = pyFastFss.grotto_eq_multi_eval(shared_out1, masked_x, key, seed1, 1, points, bit_width, element_num)
