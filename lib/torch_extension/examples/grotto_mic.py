...
pyFastFss.grotto_key_gen(key, alpha, seed0, seed1, bit_width_in, element_num)
...
pyFastFss.grotto_mic_eval(shared_out0, masked_x, key, seed0,
                          0, left_bound, right_bound, bit_width_in, element_num)
pyFastFss.grotto_mic_eval(shared_out1, masked_x, key, seed1,
                          1, left_bound, right_bound, bit_width_in, element_num)

out = pyFastFss.mod(shared_out0 + shared_out1, 1).reshape(element_num, -1)
