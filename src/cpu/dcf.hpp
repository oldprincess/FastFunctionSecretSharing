#pragma once
#ifndef SRC_FAST_FSS_CPU_DCF_HPP
#define SRC_FAST_FSS_CPU_DCF_HPP
...
template <typename GroupElement>
static GroupElement convert(const std::uint64_t s[2], int bitWidthOut) noexcept
{
    assert(bitWidthOut <= 128);
...
template <typename GroupElement>
inline void dcfKeySetPtr(DcfKey<GroupElement>& dcfKey,
                         const void*           keyData,
...
template <typename GroupElement>
inline void dcfKeyGen(DcfKey<GroupElement>& key,
                      GroupElement          alpha,
                      GroupElement          beta,
                      const void*           seed0,
                      const void*           seed1,
...
template <typename GroupElement>
inline GroupElement dcfEval(const DcfKey<GroupElement>& key,
